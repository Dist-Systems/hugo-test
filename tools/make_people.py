        ...
        if (record['public'] and record['current']):
            ...
            if(isinstance(file_name, str)):
                ...
                if (file_name in files_to_display):
                    copyfile(os.path.join(archive_location,file_name),os.path.join(person_directory,file_name))
                else:
...
if __name__ == "__main__":
    ...
    archive_location = '/home/ncs/Projects/seclab-website/tools/people_photos/'
    main(ppl_file, template_filename, out_directory, archive_location)